...
if(isset($link)){
$id_sensore=mysqli_real_escape_string($link,$_POST['id']);
...
$sql="INSERT INTO $tbl_name (id_sensore, tipo, marca, sito,attivo) VALUES ('$id_sensore','$tipo','$marca','$sito','1');";
$result=mysqli_query($link,$sql);
if(isset($result)){
header('Location:sensori.php');
}else{
echo'QUERY FALLITA';}
