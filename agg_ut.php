...
$data=mysqli_real_escape_string($link,date('Y/m/d'));
$ruolo=mysqli_real_escape_string($link,$_POST['ruolo']);
$sql="INSERT INTO $tbl_name (username, password, nome,via ,civico, CAP,registrazione,ruolo) VALUES ('$username','$password','$nome','$via','$civico','$CAP','$data','$ruolo');";
