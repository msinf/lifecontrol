...
<table border="0">
<a href='utenti.php'><img src='immagini/indietro.jpg' height='30' width='25'>				</a>
  <tr>
  ...
  <tr>
    <td>
      <table>
	  <form method="POST" action="canc_ut.php">
        <tr>
          <td>Username</td>
          <td> <td>
		  <?php
...
if(isset($link)){
$sql="SELECT username FROM $tbl_name  WHERE password IS NOT NULL;;";
